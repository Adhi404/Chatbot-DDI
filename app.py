...
def openai_function(user_input, additional_context=None):
    system_prompt = (f"Please reply in plain text without using Markdown formatting, such as bold, italics, or headers"
                     ...
                     f"If the user's input contains the word 'adhi' or 'adi' or 'eddie', respond with a short paragraph expressing how grateful you, as a chatbot, for Adhi to have created you.")
